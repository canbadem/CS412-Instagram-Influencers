...
print("=====================================")
print("Classification RandomForest")
print("=====================================")
...
x_train, x_val, y_train, y_val, pca = common.DoPCA(x_combined_train, y_train,pca_components=100,val_size=0.2)
model = RandomForestClassifier(class_weight="balanced", random_state=42,max_depth=None, max_features='sqrt', min_samples_leaf=1, min_samples_split=10,n_estimators=200)
...
if doParamSearch:
    ...
    grid_search = GridSearchCV(RandomForestClassifier(random_state=42), param_grid, cv=5, scoring='accuracy', verbose=10, n_jobs=-1)
